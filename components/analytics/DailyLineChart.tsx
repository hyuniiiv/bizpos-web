...
import type { DailySummary } from '@/lib/analytics/queries'
  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <LineChart data={chartData} margin={{ top: 4, right: 16, bottom: 4, left: 8 }}>
        ...
        <XAxis dataKey="date" tick={{ fontSize: 12, fill: 'rgba(255,255,255,0.5)' }} axisLine={{ stroke: 'rgba(255,255,255,0.15)' }} tickLine={false} />
        <YAxis
